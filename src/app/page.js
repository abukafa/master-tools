  ...
  const tools = [
    {
      ...
      desc: "Convert & compress images effortlessly.",
      href: "/tools/image-converter",
      isPremium: false,
    },
    {
      title: "QR Generator",
      desc: "Create elegant QR codes.",
      href: "/tools/qr-generator",
      isPremium: false,
    },
    {
      title: "Code Formatter",
      desc: "Beautify your snippets.",
      href: "/tools/code-formatter",
      isPremium: false,
    },
    {
      title: "PDF Studio",
      desc: "Securely split and merge PDFs.",
      href: "/tools/pdf-studio",
      isPremium: false,
    },
    {
      title: "Text Suite",
      desc: "Extract, read, dan dictate text.",
      href: "/tools/text-extractor",
      isPremium: false,
    },
    {
      title: "Color Generator",
      desc: "Neon palettes & smooth CSS gradients.",
      ...
      <div className="z-10 max-w-5xl w-full flex flex-col items-center gap-12 text-center relative">
        <div className="space-y-6">
          ...
          <p className="max-w-[600px] text-lg text-muted-foreground mx-auto font-sans">
            Aesthetic and powerful suite of utilities tool designed for
            elegance, productivity, and work efficiency.
          </p>
        </div>
          ...
          {tools.map((tool, i) => (
            ...
            >
              ...
              <h3 className="font-display text-2xl font-semibold mb-2 relative z-10 text-foreground group-hover:text-primary transition-colors">
                {tool.title}
                {tool.isPremium && (
                  <span className="ml-2 text-[10px] uppercase tracking-wider bg-primary/20 text-primary px-2 py-1 rounded-full align-middle">
                    Pro
                  </span>
                )}
              </h3>
        ...
        <div className="mt-8">
          {isGuestOrPublic ? (
            <Link href="/login">
              <Button
                size="lg"
                className="rounded-full px-8 font-semibold tracking-wide bg-gradient-to-r from-primary to-secondary text-primary-foreground border-0 transition-all hover:scale-105 hover:btn-glow"
              >
                Join Lubna Circle
              </Button>
            </Link>

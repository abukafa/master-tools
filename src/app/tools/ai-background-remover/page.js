      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-8">
        <div className="mb-8 text-center md:text-left">
          ...
          <p className="text-muted-foreground mt-2 font-sans max-w-xl">
            Hapus latar belakang foto dalam hitungan detik menggunakan AI.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              {previewUrl ? (
                ...
                <div className="text-center space-y-4 p-8 text-muted-foreground">
                  ...
                  <p className="text-sm">
                    Maksimal resolusi direkomendasikan: 25 Megapixel
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="space-y-4">
            ...
            <div
              className="aspect-square rounded-3xl border border-border bg-gradient-to-br from-card/30 to-background flex flex-col items-center justify-center overflow-hidden relative"
              style={{
                backgroundImage:
            ...
            >
              ...
              {loading && (
                <div className="text-center space-y-4 p-8 text-primary">
                  ...
                  <p className="font-sans font-medium animate-pulse">
                    Memproses AI...
                  </p>
                </div>
              )}
        ...
        <div className="flex justify-center gap-4 pt-4">
          ...
          {resultUrl && (
            <a href={resultUrl} download="lubna-bg-removed.png">
              <Button
                size="lg"
                variant="secondary"
                className="rounded-full px-8 gap-2 hover:scale-105 transition-transform"
              >
